...
import com.aakash.example.autocam.ui.camera.CameraSourcePreview;
    ...
    private void takeShot() {
        mCameraSource.takePicture(null, new CameraSource.PictureCallback() {
            ...
            public void onPictureTaken(byte[] bytes) {
                ...
                shareIntent.putExtra(Intent.EXTRA_STREAM, FileProvider.getUriForFile(FaceTrackerActivity.this, BuildConfig.APPLICATION_ID, shot));
